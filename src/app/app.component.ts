  ...
  ngAfterViewInit() {
    ...
    */
    ...
    function init(){
      ...
      /*
      body.camera.rotation.y = 45/180*Math.PI;
      body.camera.position.x = 800;
      body.camera.position.y = 100;
      body.camera.position.z = 1000;
      */
      ...
      */
      ...
      /*
      body.loader = new VRMLLoader();
      
      body.loader.load("./../assets/models/robot.wrl", function(model){
        model.position.set(1.9, 0, 0)
